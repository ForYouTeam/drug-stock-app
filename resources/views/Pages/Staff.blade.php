            ...
            <div class="modal-body">
              <div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="position" id="position" class="form-control mt-2" placeholder="Input disini">
                    <span class="text-danger" id="alert-position"></span>
                </div>
                <div class="form-group">
                    <input type="hidden" name="id" id="id">
                    ...
                    <span class="text-danger" id="alert-user_id"></span>
                </div>
              </div>
            </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#btn-del', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: `${baseUrl}/api/v1/staff/${dataId}`,
                        type: 'delete',
        ...
        $(document).on('click', '#btn-edit', function() {
            clearInput()
            let dataId = $(this).data('id')
            $.get(`${baseUrl}/api/v1/staff/${dataId}`, (res) => {
                let data = res.data
                $.each(data, (i,d) => {
                ...
                $.each(data, (i,d) => {
                    $('#tbody').append(`
                        <tr>
                            ...
                            <td class="text-capitalize">${d.position}</td>
